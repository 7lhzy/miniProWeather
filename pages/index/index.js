...
Page({
  ...
  getCity: function (latitude, longitude) {
    ...
    var params = {
      ak: "2bY4sHWlWQZqeqdns5u78ZumcYRTX40k",
      output: "json",
      location: latitude + "," + longitude
    }
    wx.request({
      url: 'https://api.map.baidu.com/geocoder/v2/?ak=2bY4sHWlWQZqeqdns5u78ZumcYRTX40k&location=' + latitude + ',' + longitude + '&output=json&coordtype=wgs84ll',
      ...
      success: function (res) {
        ...
        that.setData({ city: city, district: district, street: street, })
  ...
  getWeahter: function (city) {
    ...
    var parameters = {
      location: city,
      key: "df768a3147d741ebbf50e9d2bb5283b6"
    }
    wx.request({
      url: url,
      data: parameters,
